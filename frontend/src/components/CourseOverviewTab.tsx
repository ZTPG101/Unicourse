      ...
      <div className="course-details__tab-inner">
        <div className="course-details__overview">
          ...
          <p className="course-details__overview-text-1">
            Master Python Programming for Beginners and Beyond is a
            comprehensive course designed to take you from the fundamentals of
            Python to advanced topics, providing you with the skills needed to
          ...
          <ul className="course-details__overview-points list-unstyled">
            ...
            <li>
              ...
              <div className="course-details__overview-points-content">
                ...
                <p>
                  Grasp OOP principles with Python, including classes, objects,
                  inheritance,
